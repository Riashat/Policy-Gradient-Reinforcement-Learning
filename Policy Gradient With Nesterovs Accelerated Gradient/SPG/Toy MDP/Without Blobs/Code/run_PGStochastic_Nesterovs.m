...
function [meanReward, rwdBlob1, rwdBlob2, rwdBlob3,  totalReward,  Step_Size_Results, Cum_Rwd_Sigma] = run_PGStochastic_Nesterovs ()
...
sigma = [0.45, 0.5];   %is this the ideal sigma value for SPG?
...
n_epsilon= [10, 20, 40, 100, 200, 500, 1000]; 

momentum = [1, 5, 10, 20, 40, 100, 200, 500, 1000];
...
for s = 1:length(sigma)
    ...
    %save results
    save 'All Results SPG With Nesterovs Optimization Toy MDP.mat'
