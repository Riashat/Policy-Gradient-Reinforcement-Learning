function [cum_rwd] = PGDeterministic(agent, mdp, iterations, momentum, n_epsilon, sigma)

fprintf('\Deterministic Policy Gradient With Nesterovs\n');
...
%     momentum = min( min_mom, max_mom);
    ...
    Velocity = momentum*Old_Velocity + n_epsilon * gradient_inc;
