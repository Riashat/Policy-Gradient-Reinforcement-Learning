%function for Stochastic Natural Policy Gradient
function [meanReward, rwdBlob1, rwdBlob2, rwdBlob3,  totalReward,  Step_Size_Results, Cum_Rwd_Sigma] = run_StochasticNaturalPolicyGradient ()
...
%sigma = [0.2, 0.35, 0.45, 0.6];   %is this the ideal sigma value for SPG?
...
for s = 1:length(sigma)
    ...
    %save results
    save 'All Results Natural SPG Toy MDP Without Local Blobs.mat'
